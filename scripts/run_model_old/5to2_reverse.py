...
def dpl_selfmadehydrodataset_args(gage_id):
    project_name = os.path.join("data-limited_analysis_5to2_15-20_lrchange_reverse", gage_id)
    train_period = ["2019-10-01", "2021-10-01"]
    valid_period = ["2015-10-01", "2020-10-01"]
    # valid_period = None
    test_period = ["2015-10-01", "2020-10-01"]
    return cmd(
        sub=project_name,
        source_cfgs={
