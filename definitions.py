...
try:
    ...
    # 只覆盖 definitions_private 中存在的变量
    if hasattr(definitions_private, "PROJECT_DIR"):
        PROJECT_DIR = definitions_private.PROJECT_DIR
    if hasattr(definitions_private, "RESULT_DIR"):
        RESULT_DIR = definitions_private.RESULT_DIR
    if hasattr(definitions_private, "DATASET_DIR"):
        DATASET_DIR = definitions_private.DATASET_DIR
    if hasattr(definitions_private, "CAMELS_DPL_PARENT_DIR"):
        CAMELS_DPL_PARENT_DIR = definitions_private.CAMELS_DPL_PARENT_DIR
    if hasattr(definitions_private, "SANXIA_DPL_DIR1"):
        SANXIA_DPL_DIR1 = definitions_private.SANXIA_DPL_DIR1
    if hasattr(definitions_private, "SANXIA_DPL_DIR2"):
        SANXIA_DPL_DIR2 = definitions_private.SANXIA_DPL_DIR2
    if hasattr(definitions_private, "CHANGDIAN_DPL_PARENT_DIR"):
        CHANGDIAN_DPL_PARENT_DIR = definitions_private.CHANGDIAN_DPL_PARENT_DIR
    if hasattr(definitions_private, "CAMELS_IDS"):
        CAMELS_IDS = definitions_private.CAMELS_IDS
    if hasattr(definitions_private, "CHANGDIAN_IDS"):
        CHANGDIAN_IDS = definitions_private.CHANGDIAN_IDS
    if hasattr(definitions_private, "SANXIA_SCEUA_DIR1"):
        SANXIA_SCEUA_DIR1 = definitions_private.SANXIA_SCEUA_DIR1
    if hasattr(definitions_private, "CHANGDIAN_SCEUA_RESULT_DIRS"):
        CHANGDIAN_SCEUA_RESULT_DIRS = definitions_private.CHANGDIAN_SCEUA_RESULT_DIRS
    if hasattr(definitions_private, "CHANGDIAN_ID_NAME_DICT"):
